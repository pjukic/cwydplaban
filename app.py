...
# Update the `initialize_vectorstore` function
def initialize_vectorstore(db_type=DB_TYPE):
    try:
        ...
        if db_type == "faiss":
            embedding_dimension = 384  # Adjust to your embedding model's dimension
            ...
            # Initialize Milvus configuration (adjust host, port, etc. as needed)
